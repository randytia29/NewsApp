...
public class QueryUtils {
    ...
    private static ArrayList<News> extractNewses(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                String time = news.getString("webPublicationDate");

                newses.add(new News(sectionName, webTitle, url, time));
            }
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> news = extractNewses(jsonResponse);
